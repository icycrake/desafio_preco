		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Desafio: Atualização de preços",
									"targetURL": "#desafiopreco-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"desafiopreco-display": {
								"semanticObject": "desafiopreco",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=desafiopreco",
									"url": sap.ui.require.toUrl("desafiopreco")
								}
							}
						}
					}
